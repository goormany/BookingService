...
class TestGetActiveBookingsByDate:
    async def test_get_active_bookings_by_date_success_without_room_id(
        self, repo, mock_session, mock_model
    ):
    ...
    async def test_get_active_bookings_by_date_success_with_room_id(
        self, repo, mock_session, mock_model
    ):
        mock_scalars = MagicMock()
        mock_scalars.all.return_value = [mock_model]
    ...
    async def test_get_active_bookings_by_date_success_not_found_booking(
...
class TestCreateBooking:
    ...
    async def test_create_booking_success(
        self, repo, mock_model, mock_session, mock_create_booking_schema
    ):
        mock_row = MagicMock()
    ...
    async def test_not_exist_slots(
        self, repo_with_mock_add, mock_session, mock_create_booking_schema
    ):
        mock_row = MagicMock()
    ...
    async def test_room_busy_on_this_time(
        self, repo, mock_session, mock_create_booking_schema
    ):
        mock_row = MagicMock()
        mock_row.has_slot = True
        mock_row.has_conflict = False

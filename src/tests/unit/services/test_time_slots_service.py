...
from src.utils.exceptions.exceptions import BookingRoomsInvalidObjReferences, BookingRoomsNotFoundObjException, BookingRoomsObjUniquessException, RoomNotFoundException, TimeSlotNotFoundException, TimeSlotsUniquessException, TimeValueValidationException

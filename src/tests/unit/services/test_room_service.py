...
@pytest.fixture
def room_in():
    return RoomCreate(name="test name")
...
class TestUpdateRoom:
    async def test_success(self, service, args, kwargs):
        ...
        result = await service.update_room(room_upd, *args, **kwargs)
    ...
    async def test_not_found_room(self, service, args, kwargs):
        ...
        with pytest.raises(RoomNotFoundException):
            await service.update_room(room_upd, *args, **kwargs)
